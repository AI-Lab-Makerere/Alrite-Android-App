...
public class MutipleSelectionComponent {
    private Map<Integer, String> MultipleSelect;
     ...
     */
    public MutipleSelectionComponent() {
...
//    }
    ...
    public void addMultipleChoiceValue(Integer ChoiceNum, String ChoiceName) {
        ...
        this.MultipleSelect.put(ChoiceNum, ChoiceName);
    }
}
